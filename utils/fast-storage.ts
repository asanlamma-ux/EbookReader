...
const translationStorage = new MMKV({ id: 'miyo-translation-cache' });
...
export const TranslationCacheStorage = {
  set(key: string, value: string): void {
    translationStorage.set(key, value);
  },

  get(key: string): string | undefined {
    return translationStorage.getString(key);
  },
  ...
  getAllKeys(): string[] {
    return translationStorage.getAllKeys();
  },
};
